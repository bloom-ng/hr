            ...
            <div class="col-xs-12">
                <div class="box border-t-10 border-[#DA7F00] bg-[#2C2C2C]">
                    ...
                    <form action="<?php echo base_url(); ?>payroll/update" method="POST">
                                    ...
                                    <div class="block min-w-full overflow-y-auto rounded-lg shadow max-h-screen ">
                                        ...
                                        <table class=" min-w-full leading-normal overflow-x-auto  scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                            <thead class="sticky top-0">
                                                <tr class="">
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-white border-b border-gray-200">
                                                    </th>
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-white border-b border-gray-200">
                                                    </th>
                                                    ...
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-blue-50 border-b border-gray-200">
                                                    </th>
                                                    <th scope="col" colspan="4" class="text-center text-[11px] font-semibold px-5 py-3 text-sm font-normal  text-gray-800 uppercase bg-green-50 border-b border-gray-200">
                                                        Additions
                                                    </th>

                                                    <th scope="col" colspan="4" class="justify-center text-[11px] font-semibold px-5 py-3 text-sm font-normal text-center text-gray-800 uppercase bg-red-50 border-b border-gray-200">
                                                        Deductions
                                                    </th>

                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-green-100 border-b border-gray-200">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-green-50 border-b border-gray-200">
                                                        Advance Salary (&#8358;)
                                                    </th>
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-green-50 border-b border-gray-200">
                                                        Loans (&#8358;)
                                                    ...
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-red-50 border-b border-gray-200">
                                                        Advance Salary (&#8358;)
                                                    </th>
                                                    <th scope="col" class="text-[11px] font-semibold px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-red-50 border-b border-gray-200">
                                                        Loans (&#8358;)
                                                        ...
                                                        <tr class=" hover:bg-gray-200 ">
                                                            ...
                                                            <td class="px-5 py-5 text-sm bg-blue-50 border-b border-gray-200 w-6">
                                                                <p id="gross_income_<?php echo $cnt['id'] ?>" class="text-gray-900 whitespace-no-wrap">
                                                                    <input class="bg-blue-50" type="text" readonly id="gross_<?php echo $cnt['id'] ?>" value="<?php echo number_format($gross, 2) ?>" />
                                                                </p>
                                                            </td>
                                                            ...
                                                            <td class="px-5 py-5 text-sm bg-green-100 border-b border-gray-200">
                                                                <p class="text-gray-900 whitespace-no-wrap">
                                                                    <input class="bg-green-100" type="text" readonly id="net_<?php echo $cnt['id'] ?>" value="<?php echo number_format($net, 2) ?>" />
                                                                </p>
                                                            </td>
                        ...
                        <input name="payrolls" type="hidden" value="<?php foreach ($payrolls as $payroll) {
                                                                        echo $payroll['id'] . ",";
                                                                    } ?>" />
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                                        <textarea cols="30" class="border-b border-gray-300" rows="5" name="remark_<?php echo $s['id'] ?>"><?php echo $s['remark'] ?></textarea>
