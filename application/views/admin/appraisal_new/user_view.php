<div class="content-wrapper bg-[#3E3E3E]">
    <div class="content-header">
        <h1 class="m-0 text-dark">My Appraisal (2026)</h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box border-t-10 border-[#DA7F00] bg-[#2C2C2C]">
                        ...
                        <form role="form" action="<?php echo base_url('appraisal_new/staff_comment/'.$appraisal['id']); ?>" method="post">
                            <div class="box-body">
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="employee_remarks" id="employee_remarks" rows="3"><?php echo $appraisal['employee_remarks']; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="hr_remarks">HR Approval/Remarks</label>
                                    <textarea class="form-control" name="hr_remarks" id="hr_remarks" rows="3" readonly><?php echo $appraisal['hr_remarks']; ?></textarea>
                                </div>
