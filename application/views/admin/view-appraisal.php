...
<div class="content-wrapper bg-neutral-800">
    ...
    <section class="content-header bg-neutral-800">
        <h1>Check Appraisal</h1>
        <ol class="breadcrumb text-white">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Appraisals</a></li>
            <li class="active">Check Appraisal</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-info bg-neutral-800">
                    <div class="box-header">
                        <h3 class="box-title text-white">Check Appraisal</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <?php echo form_open('appraisal/save_appraisal_comment/' . $appraisal['id']); ?>
                        ...
                        <<!-- Achievement of Goals -->
                            ...
                            <?php if ($appraisal['status'] == 'review' && $appraisal['created_by'] !== $this->session->userdata('userid') && in_array($this->session->userdata('role'), ["hrm", "super"])) : ?>
                                <button type="submit" class="btn btn-success text-[#DA7F00] hover:bg-[#DA7F00] bg-white border-0">Save Comment</button>
                            <?php endif; ?>

                            <?php if ($appraisal['status'] == 'review' && in_array($this->session->userdata('role'), ["hrm", "super"])) : ?>
