                                ...
                                <?php if(isset($staff_members)): ?>
                                    <?php $i=1; foreach($staff_members as $staff): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-info" data-toggle="modal" data-target="#manageModal<?php echo $staff['id']; ?>">Check</button>
                                                <button class="btn btn-success" data-toggle="modal" data-target="#attendanceModal<?php echo $staff['id']; ?>">Add</button>
                                            </td>
                                        </tr>
    ...
    $(document).ready(function () {
        ...
        $('#date').on('change', function () {
            ...
            $.ajax({
                ...
                data: { staff_id: staffId, date: selectedDate },
