			...
			<div class="col-xs-12">
				<div class="box border-t-10 border-[#DA7F00] bg-[#2C2C2C]">
					<div class="box-header">
						<h3 class="box-title text-white">List Appraisals</h3>
					</div>
					<?php if (isset($hod)) : ?>
						<?php if ($hod || in_array($this->session->userdata('role'), ["hrm", "super"])) : ?>
							<div class="box-header">
								...
								<div class="d-flex mt-3">
									<a href="<?php echo base_url(); ?>add-appraisal/<?php echo $staff['id']; ?>" class="btn btn-info border-[#DA7F00] hover:border-[#DA7F00] hover:bg-[#DA7F00] bg-[#DA7F00]">Add Appraisal</a>
								</div>
							</div>
						<?php endif; ?>
					<?php endif; ?>
