        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Commissions for <?php echo $staff['staff_name'] ?></h3>
              <div class="d-flex mt-3">
              <button type="button" class="btn btn-primary bg-blue-600 hover:bg-blue-500" data-toggle="modal" data-target="#commissionModal">
                Add
              </button>
              </div>
            </div>
              ...
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                      ...
                      <div class="modal fade" id="commissionModal<?php echo $cnt['id']; ?>" tabindex="-1" role="dialog" 
                          aria-labelledby="commissionModalLabel<?php echo $cnt['id']; ?>">
                                    ...
                                    <?php echo form_open("commission/update/{$cnt['id']}"); ?>
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="date" 
                                                  value="<?php echo $cnt['date'] ?>" name="date" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="client">Client:</label>
                                            <input type="text" class="form-control" id="client" 
                                                value="<?php echo $cnt['client'] ?>" name="client" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="total">Total (&#8358;) :</label>
                                            <input type="number" class="form-control" id="total" 
                                                value="<?php echo $cnt['total'] ?>"name="total" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="commission">Commission (%):</label>
                                            <input type="number" class="form-control" id="commission" 
                                                value="<?php echo $cnt['commission'] ?>" name="commission" required>
                                        </div>
                                        <div class="form-group">
