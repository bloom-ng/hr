...
<body class="hold-transition bg-[#000000] sidebar-mini">
  <div class="wrapper">

    <header class="main-header bg-[#000000]">
      <!-- Logo -->
      ...
      <a href="#" class="logo">
        ...
        <span class="uppercase font-black text-[#FF9501]"><b>Bloom</b></span><span class="uppercase font-black text-white">HR</span>
      </a>
...
<!--				  <li><a href="--><?php //echo base_url(); ?><!--attendance-export"><i class="fa fa-circle-o"></i> Show Attendance</a></li>-->
  ...
  <?php
>>>>>>> b3bd5442888ea185456516e7b9dafe868553b18f
