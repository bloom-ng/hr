            ...
            <div class="col-xs-12">
                <div class="box border-t-10 border-[#DA7F00] bg-[#2C2C2C]">
                    <div class="box-header">
                        <h3 class="box-title text-white">Manage Reports</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                ...
                                <?php if (isset($staff_members)) : ?>
                                    ...
                                    foreach ($staff_members as $staff) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>list-report/<?php echo $staff['id']; ?>" class="btn btn-infohover:border-[#DA7F00] border-[#DA7F00] bg-[#DA7F00] hover:bg-[#DA7F00]">Reports</a>
                                            </td>
