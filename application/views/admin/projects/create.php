...
<div class="content-wrapper bg-[#3E3E3E]">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-white">Create New</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box border-t-10 border-[#DA7F00] bg-[#2C2C2C]">
                    <div class="box-header">
                        <h3 class="box-title text-white">Project Details</h3>
                        <div class="box-tools">
                            <a href="<?php echo site_url('projects'); ?>" class="btn btn-default hover:border-[#DA7F00] border-[#DA7F00] bg-[#3E3E3E] hover:bg-[#DA7F00] text-white">
