...
<head>
    ...
    <title>Bloom EMS - Anonymous</title>
                ...
                <div class="flex flex-col justify-center flex-grow">
                    <div class="flex items-center justify-center
                      ...
                      text-4xl md:text-[48px] pb-[10%] uppercase leading-[57px]">
                        <a href="#"><span class="text-[#FF9501]"><b>Bloom </b></span> <span class="text-white "> Employee Management System(EMS)</span><span class="text-[#FF9501]"><b>Anonymous</b></span></a>
                    </div>
                    <!-- /.login-logo -->
                    <div class="">
                        <!-- <p class="">Please Login To Continue..</p> -->

                        <?php echo form_open('Anonymous/insert'); ?>
                        <!-- form-group has-feedback -->
                        <div class="flex flex-col gap-6">
                            <div class="mr-[6%]">
                                <input class="placeholder-gray-400 italic w-full px-4 py-4" type="text" name="subject" class="form-control" placeholder="Subject">
                                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                            </div>
                            <div class="mr-[6%]">
                                <textarea class="placeholder-gray-400 italic w-full px-4 py-4" name="message" class="form-control" placeholder="Message" rows="10"></textarea>
