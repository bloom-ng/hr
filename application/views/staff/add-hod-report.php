...
<div class="content-wrapper bg-[#3E3E3E]">
    ...
    <section class="content-header">
        <h1>Add <?php echo $department['department_name'] ?> Report</h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                <div class="box border-t-10 border-[#DA7F00] bg-[#2C2C2C]">
                    <div class="box-header">
                        <h3 class="box-title text-white">Add <?php echo $department['department_name'] ?> Report</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <?php echo form_open('report/insert_hod_report'); ?>
                        <div class="form-group">
                            <input type="text" class="form-control" id="staff_id" name="staff_id" value="<?php echo $department["staff_id"]; ?>" hidden>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="month" class="form-control" id="date" name="date" placeholder="MM/YYYY" required>
                        </div>
