  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>" class="logo">
        ...
        <span class="logo-lg"><b>Bloom</b> EMS</span>
      </a>
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu bg-[#3E3E3E]">
          <ul class="nav navbar-nav bg-[#3E3E3E]">
            <!-- User Account: style can be found in dropdown.less -->
            <li class="dropdown user user-menu  bg-[#3E3E3E]">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo base_url(); ?>logout" class="btn btn-default bg-[#595959] hover:bg-[#595959] border-0 btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
