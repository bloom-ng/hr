				...
				<div class="box box-info bg-neutral-800">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="assigned_projects_count" value="<?php echo $appraisal['assigned_projects_count']; ?>" readonly><br>
						...
						<div class="form-group">
							...
							<textarea id="additional_comments" name="additional_comments" class="form-control" placeholder="Provide specific comments and feedback." readonly><?php echo $appraisal['additional_comments']; ?></textarea>
						</div>
						...
						<div class="form-group">
							...
							<textarea id="manager_comments" name="manager_comments" class="form-control" placeholder="Provide space for the manager to provide overall comments and feedback." readonly><?php echo $appraisal['manager_comments']; ?></textarea>
						</div>

						<!-- Action Plan for Improvement -->
						<div class="form-group">
							<label for="action_plan_for_improvement">X. Action Plan for Improvement:</label>
							<textarea id="action_plan_for_improvement" name="action_plan_for_improvement" class="form-control" placeholder="Outline specific steps and goals for the employee's improvement." readonly><?php echo $appraisal['action_plan_for_improvement']; ?></textarea>
						</div>
